# 《奔跑吧 Linux內核》（第二版）卷2 第 2 章 中斷管理 高頻面試題

> **說明**：收錄自《奔跑吧 Linux內核》（第二版）卷2 第 2 章〈中断管理〉開篇「本章的高頻面試題」，共計 15 題。
> **來源檔案**：`books/running-linux-kernel/running-kernel-2-txt/09_第2章_中断管理.txt`
